	...
	*/
	...
	case "HCP":
		if nivel == "PREGRADO" {
			...
			articulo = Articulo{Texto: "VINCULACIÓN: Vincular a los siguientes docentes para el periodo académico 2023-III, comprendido entre el 01 de agosto al 09 de diciembre de 2023, en los programas de pregrado de la Universidad Distrital Francisco José de Caldas, en la modalidad de Hora Cátedra Prestaciones, en el escalafón y dedicación establecidas en la siguiente tabla, y con cargo a los recursos asignados en el Certificado de Disponibilidad Presupuestal (Sueldo Básico, Prima Vacaciones, Prima Navidad, y Cesantías) XXXXX del XX de XXXX de 2023: \n\n"}
		}
		if nivel == "POSGRADO" {
