...
func GetTemplateResolucion(dedicacion, nivel, periodo, tipo string) (res ResolucionCompleta) {
	...
	*/
	...
	case "HCH":
		if nivel == "PREGRADO" {
			resolucion = ResolucionCompleta{Consideracion: "Que mediante los artículos 3º y 4º del Decreto 1279 del 19 de junio de 2002, el Gobierno Nacional estableció la naturaleza jurídica, laboral y prestacional de los docentes de las universidades estatales u oficiales del orden nacional, departamental, municipal y distrital, prescribiendo en su artículo 3º que “(…) los profesores de hora-cátedra de las Universidades estatales u oficiales distintas a la Universidad Nacional de Colombia no son empleados públicos docentes de régimen especial ni pertenecen a la carrera profesoral y, por consiguiente, sus condiciones salariales y prestacionales no están regidas por el presente Decreto, sino por las reglas contractuales que en cada caso se convengan, conforme a las normas internas de cada Universidad, con sujeción a lo dispuesto en las disposiciones constitucionales y legales”.\n\nQue con carácter general, el artículo 128 de la Constitución Política establece que “nadie podrá desempeñar simultáneamente más de un empleo público ni recibir más de una asignación que provenga del tesoro público, o de empresas o de instituciones en las que tenga parte mayoritaria el Estado, salvo los casos expresamente determinados por la ley (…) Entiéndese por tesoro público el de la Nación, el de las entidades territoriales y el de las descentralizadas”.\n\nQue en desarrollo de este precepto superior, el artículo 19 de la Ley 4ª de 1992 establece que “nadie podrá desempeñar simultáneamente más de un empleo público, ni recibir más de una asignación que provenga del Tesoro Público, o de empresas o de instituciones en las que tenga parte mayoritaria el Estado. Exceptúense las siguientes asignaciones: (…) d) Los honorarios percibidos por concepto de hora-cátedra…”.\n\nQue el parágrafo de la precitada norma prevé que “no se podrán recibir honorarios que sumados correspondan a más de ocho (8) horas diarias de trabajo a varias entidades”.\n\nQue la Corte Constitucional en Sentencia C-133 de 1993 señaló que “si bien es cierto que en el artículo 128 C.P. se consagra una incompatibilidad, no lo es menos que ésta se encuentra en íntima relación de conexidad con la remuneración de los servidores estatales; basta ver que en ella se prohíbe la concurrencia de dos o más cargos públicos en una misma persona, tanto como recibir más de una asignación que provenga del erario público. El término ‘asignación´’ comprende toda clase de remuneración que emane del tesoro público, llámese sueldo, honorario, mesada pensional, etc. …”.\n\nQue de conformidad con las normas y la jurisprudencia expuestas, la persona que tiene la calidad de pensionado del sector público podrá percibir otra asignación del Tesoro Público, siempre que la misma provenga de las excepciones establecidas en el artículo 19 de la Ley 4ª de 1992, como es el caso de los honorarios percibidos por los docentes que presten el servicio a una universidad o institución de educación del Estado, mediante el sistema de hora cátedra honorarios.\n\nQue mediante Resolución Nro. 001 de 15 de febrero de 2012 proferida por la Vicerrectoría Académica, se estableció el procedimiento para la selección y vinculación a la Universidad Distrital Francisco José de Caldas de docentes de vinculación especial.\n\nQue se hace necesario garantizar el reconocimiento de honorarios a docentes de hora cátedra en virtud de la Ley 4ª de 1992 realicen actividades de horas lectivas señaladas en el calendario académico y que no son suplidas por los docentes de carrera de la entidad.\n\nQue mediante Acuerdo 002 de marzo 17 de 2011 proferido por el Consejo Superior Universitario, se modificó el artículo 43 del Acuerdo 011 de 2002, de manera que se pueden reconocer honorarios a personal pensionado en la modalidad de docentes de hora cátedra por honorarios (HCH).\n\nQue para efectos del pago de los servicios prestados por los docentes hora catedra honorarios, se hará de conformidad con las horas lectivas efectivamente dictadas y aprobadas en los diferentes programas, así como en concordancia con el calendario académico emitido por el Consejo Académico mediante Resolución 06 de 2 de marzo del 2021 para programas de pregrado.\n\nQue a los servidores públicos y pensionados del sector público se les reconocerán honorarios hora catedra (HCH) de conformidad con lo dispuesto en la Resolución Nro. 01 de febrero del 2012 de la Vicerrectoría Académica y hasta por un máximo de ocho (8) horas semanales en programas de pregrado.\n\nQue dado que el vínculo que se genera con el docente catedrático no tiene carácter laboral, está obligado a realizar los aportes a seguridad social por su cuenta.\n\nQue el artículo 2° del Decreto 310 de 27 febrero 2020 proferido por el Presidente de la República de Colombia, establece que “a partir del 1° de enero del 2020, fijase el valor del punto para empleados públicos docentes a quienes se les aplica el Decreto 1279 de 2002 y demás disposiciones que lo modifiquen o adicionen en catorce mil novecientos treinta y ocho pesos ($14.938) moneda corriente”.\n\nQue mediante Resolución de Rectoría Nro. 137 de abril 3 de 2020 se determinó “acoger el artículo 2 del Decreto 310 de 27 de febrero de 2020, en lo pertinente, única y expresamente al valor del punto para los docentes de Vinculación Especial hora cátedra, honorarios, Medio Tiempo Ocasional y Tiempo Completo Ocasional en pregrado, el valor del punto en CATORCE MIL NOVECIENTOS TREINTA Y OCHO PESOS ($14.938) MONEDA CORRIENTE”.\n\nQue en materia de Seguridad y Salud en el Trabajo (SST), para docentes de hora cátedra honorarios de la Universidad Distrital Francisco José de Caldas, se deben informar las obligaciones específicas de que trata el artículo 2.2.4.2.2.16. del Decreto 1072 de 2015, así como la Resolución de Rectoría No. 624 de 2017, conforme a los cuales el docente ocasional, de hora catedra y por honorarios, debe cumplir con las normas del Sistema General de Riesgos Laborales.\n\nQue el Consejo Académico en ejercicio de las funciones establecidas en los literales b) y e) del Artículo 18 del Estatuto General de la Universidad Distrital Francisco José de Caldas (Acuerdo 003 de abril 08 de 1997), mediante Resolución Nro. 06 de marzo 02 de 2021, aprobó “el Calendario Académico especial del año 2021, para los programas académicos de pregrado bajo la modalidad virtual y/o alternancia, y se modifica la programación de ciertas actividades académicas establecidas en la Resolución N° 073 de diciembre 23 de 2020, conexas a la culminación del segundo periodo académico del año 2020”.\n\nQue en la citada resolución el Consejo Académico determinó que las actividades académicas correspondientes al período académico 2021-I, deberán desarrollarse entre el veintitrés (23) de marzo de dos mil veintiuno (2021) y el veintitrés (23) de julio de dos mil veintiuno (2021).\n\n Que la Rectoría de la Universidad Distrital Francisco José de Caldas, en ejercicio de la autonomía universitaria y ante la problemática de salud pública originada por la Covid-19, mediante la Resolución Nro. 132 de marzo 19 de 2020, adoptó medidas transitorias y excepcionales de orden interno, de acuerdo con los lineamientos de los Gobiernos Nacional y Distrital, para afrontar debidamente la situación de emergencia epidemiológica, evitando el contagio y garantizando la prestación del servicio a cargo de la Universidad.\n\nQue entre las medidas transitorias y excepcionales adoptadas se optó por la “suspensión de las clases presenciales en todos los programas pregrado y posgrado  (sic) de conformidad con el comunicado del 15 de marzo de 2020, a partir de las seis (6) de la mañana del 19 de marzo de 2020 y hasta nuevas instrucciones, según la actual coyuntura de salud pública, así como de emergencia económica y social”.\n\nQue con base en la Directiva Nro. 04 de 22 de marzo de 2020 del Ministerio de Educación Nacional,  con el propósito de dar continuidad, durante el periodo de emergencia sanitaria, a los programas académicos con registro calificado con que cuenta la Universidad Distrital Francisco José de Caldas, en modalidad presencial, de manera excepcional, se podrán desarrollar actividades académicas asistidas por las herramientas que ofrecen las Tecnologías de la Información y las Comunicaciones (TICs), garantizando las condiciones de calidad reconocidas en el registro calificado, sin que esto implique cambio de modalidad.\n\nQue la misma Directiva Ministerial prevé que, una vez finalizada la emergencia sanitaria, los desarrollos curriculares de los programas académicos con registro calificado en modalidad presencial, deberán desarrollarse como se venían realizando habitualmente, de acuerdo con las características propias de dicha modalidad.\n\nQue conforme a lo dispuesto en el artículo 15 del Decreto Legislativo 491 de 2020, expedido por el Presidente de la República de Colombia, que tiene por objeto que las autoridades cumplan con la finalidad de proteger y garantizar, los derechos y libertades de las personas, la primacía de los intereses generales, la sujeción de las autoridades a la Constitución y demás preceptos del ordenamiento jurídico, el cumplimiento de los fines y principios estatales, el funcionamiento eficiente y democrático de la administración, y la observancia de los deberes del Estado y de los particulares, durante el período de aislamiento preventivo obligatorio, las universidades públicas dispondrán de las medidas necesarias para que los docentes ocasionales o de hora cátedra cumplan sus funciones mediante la modalidad de \"trabajo en casa\", entre otras, haciendo uso de las tecnologías de la información y las comunicaciones (TICs).\n\nQue para efectos presupuestales, el presente acto administrativo se ejecutara con cargo a los recursos de que trata el Certificado de Disponibilidad Presupuestal No. 0xxx del xx de enero de dos mil veintiuno (2021).\n\nQue en mérito de lo expuesto,\n\n"}
			articulo = Articulo{Texto: "RECONOCIMIENTO: Reconocer Honorarios de conformidad con la Ley 4ª de 1992 para el primer periodo académico del año 2021, en los programas de pregrado de la Universidad Distrital Francisco José de Caldas, como docentes en la modalidad de Hora Cátedra Honorarios (HCH), en el escalafón y dedicación establecidas en la siguiente tabla, para el período comprendido entre el veintitrés (23) de marzo de dos mil veintiuno (2021) y el veintitrés (23) de julio de dos mil veintiuno (2021), con recursos  asignados en el Certificado de Disponibilidad Presupuestal No. xxx del xx de enero de 2021, a los siguientes docentes:"}
		}
		if nivel == "POSGRADO" {
	...
	case "TCO-MTO":
		resolucion = ResolucionCompleta{Consideracion: "Que el artículo tercero del Decreto 1279 de junio 19 de 2002, mediante el cual se establece el régimen salarial y prestacional de los docentes de las universidades estatales, señala que “los profesores ocasionales no son empleados públicos docentes de régimen especial ni pertenecen a la carrera profesoral y, por consiguiente, sus condiciones salariales y prestacionales no están regidas por el presente Decreto”, precisando que, “no obstante, su vinculación se hace conforme a las reglas que define cada Universidad, con sujeción a lo dispuesto por la ley 30 de 1992 y demás disposiciones constitucionales y legales vigentes”.\n\nQue la Universidad Distrital Francisco José de Caldas puede vincular docentes de vinculación especial en las modalidades de hora cátedra (HC), medio tiempo ocasional (MTO) y tiempo completo ocasional (TCO), de que trata el artículo 13 del Acuerdo 011 de noviembre 15 de 2002 (Estatuto Docente), a término fijo, por periodos académicos.\n\nQue mediante Resolución Nro. 001 del 15 de febrero de 2012, proferida por la Vicerrectoría Académica, se estableció el procedimiento para la selección y vinculación, a la Universidad, de docentes de vinculación especial.\n\nQue los servicios de los docentes de vinculación especial, deberán ser reconocidos en los términos del inciso segundo del artículo 74 de la Ley 30 de 1992, esto es, “mediante resolución”.\n\nQue la Corte Constitucional en Sentencia C-006 de 1996, declaró inexequibles algunos apartes del artículo 73 de la Ley 30 de 1992 y aclaró, entre otras cosas, que la vinculación de los docentes de vinculación especial estará mediada por su transitoriedad o temporalidad, de lo cual se deriva la proporcionalidad prestacional al tiempo laborado.\n\nQue conforme al concepto de 18 de diciembre 18 de 2018, emitido por el Departamento Administrativo de la Función Pública, “en el caso de la Universidad Distrital Francisco José de Caldas, debe acogerse  a lo dispuesto en sus estatutos internos o en el acuerdo en el cual defina sus políticas y criterios generales para regular los procesos de selección, vinculación y contratación de los docentes ocasionales y catedráticos, en especial en lo relacionado con el reconocimiento y pago de prestaciones sociales y remuneración…”.\n\nQue el parágrafo 1º del artículo quinto de la Resolución Nro. 001 de 2012 de la Vicerrectoría Académica, establece que, “para efectos de pago y liquidación el mes comprenderá (4) semanas o (30) días laborales en Proyectos Académicos de Pregrado y en los espacios académicos de Posgrado se pagará de acuerdo al número de horas efectivamente dictadas en cada período”.\n\nQue el artículo 2 del Decreto 310 de 27 febrero 2020, emanado por el Presidente de la República de Colombia, establece “(…) a  partir del 1° de enero del 2020, fijase el valor del punto para empleados públicos docentes a quienes se les aplica el Decreto 1279 de 2002 y demás disposiciones que lo modifiquen o adicionen en catorce mil novecientos treinta y ocho pesos ($14.938) moneda corriente (…)”.\n\nQue mediante Resolución 137 de abril 3 de 2020, emitida por Rectoría de la Universidad Distrital Francisco José de Caldas, se determinó “acoger el artículo 2 del Decreto 310 de 27 de febrero de 2020, en lo pertinente, única y expresamente al valor del punto para los docentes de Vinculación Especial hora cátedra, honorarios, Medio Tiempo Ocasional y Tiempo Completo Ocasional en pregrado, el valor del punto en CATORCE MIL NOVECIENTOS TREINTA Y OCHO PESOS ($14.938) MONEDA CORRIENTE”.\n\nQue en materia de Seguridad y Salud en el Trabajo (SST) para docentes ocasionales de la Universidad Distrital Francisco José de Caldas, se deben informar las obligaciones específicas de que trata el artículo 2.2.4.2.2.16. del Decreto 1072 de 2015, así como la Resolución de Rectoría No. 624 de 2017, conforme a los cuales, el docente ocasional, de hora catedra y por honorarios, debe cumplir con las normas del Sistema General de Riesgos Laborales.\n\nQue el Consejo Académico en uso de las funciones estatutarias establecidas en el Artículo 18, literales b.) y e.), del Estatuto General de la Universidad -Acuerdo 003 de abril 08 de 1997, expedido por el Consejo Superior Universitario-, mediante Resolución Nro. 06 de marzo 02 de 2021, aprobó “el Calendario Académico especial del año 2021, para los programas académicos de pregrado bajo la modalidad virtual y/o alternancia, y se modifica la programación de ciertas actividades académicas establecidas en la Resolución N° 073 de diciembre 23 de 2020, conexas a la culminación del segundo periodo académico del año 2020”.\n\nQue en la citada resolución, el Consejo Académico determinó en el artículo primero, que las actividades académicas correspondientes al período académico 2021-I, deberán desarrollarse entre el veintitrés (23) de marzo de dos mil veintiuno (2021) y el veintitrés (23) de julio de dos mil veintiuno (2021).\n\nQue la Rectoría de la Universidad Distrital Francisco José de Caldas en uso de la autonomía universitaria y ante la problemática de salud pública, por medio de la Resolución 132 de marzo 19 de 2020, adoptó medidas transitorias y excepcionales de orden interno, de acuerdo con los lineamientos del orden Nacional y Distrital, para afrontar debidamente la situación de emergencia epidemiológica, evitando el contagio y garantizando la prestación del servicio a cargo de la Universidad.\n\nQue entre las medidas transitorias y excepcionales adoptadas en la Resolución de Rectoría 132 de marzo 19 de 2020, se optó por la “suspensión de las clases presenciales en todos los programas pregrado y posgrado de conformidad con el comunicado del 15 de marzo de 2020, a partir de las seis (6) de la mañana del 19 de marzo de 2020 y hasta nuevas instrucciones, según la actual coyuntura de salud pública, así como de emergencia económica y social”.\n\nQue con base en la Directiva Ministerial Nº 04 del 22 de marzo de 2020 del Ministerio de Educación Nacional, y con el propósito de dar continuidad durante el periodo de emergencia sanitaria a los programas académicos con registro calificado con que cuenta la Universidad Distrital Francisco José de Caldas en modalidad presencial, de manera excepcional se podrá desarrollar actividades académicas asistidas por las herramientas que ofrecen las Tecnologías de la Información y las Comunicaciones TIC, garantizando las condiciones de calidad reconocidas en el registro calificado, sin que esto implique el cambio de modalidad.\n\nQue la misma Directiva Ministerial prevé que una vez finalizada la emergencia sanitaria, los desarrollos curriculares de los programas académicos con registro calificado en modalidad presencial deberán desarrollarse como se venía realizando habitualmente de acuerdo con las características propias de dicha modalidad.\n\nQue conforme lo dispuesto en el artículo 15 del Decreto Legislativo 491 de 2020, expedido por el Presidente de la República de Colombia, tiene por objeto que las autoridades cumplan con la finalidad de proteger y garantizar los derechos y libertades de las personas, la primacía de los intereses generales, la sujeción de las autoridades a la Constitución y demás preceptos del ordenamiento jurídico, el cumplimiento de los fines y principios estatales, el funcionamiento eficiente y democrático de la administración y la observancia de los deberes del Estado y de los particulares, durante el período de aislamiento preventivo obligatorio, las universidades públicas dispondrán de las medidas necesarias para que los docentes ocasionales o de hora cátedra cumplan sus funciones mediante la modalidad de \"trabajo en casa\", entre otras, haciendo uso de las tecnologías de la información y las comunicaciones.\n\nQue se hace necesario garantizar la vinculación de docentes hora cátedra que realicen las actividades lectivas señaladas en el calendario académico y que no son suplidas por los docentes de carrera de la Universidad Distrital\n\nQue, para efectos presupuestales, el presenta acto administrativo se ejecutara con cargo a los recursos de que trata el Certificado de Disponibilidad Presupuestal (Sueldo Básico, Prima Vacaciones, Prima Navidad, Prima de Servicios y Cesantías) No. 0xxx del xx de enero de dos mil veintiuno (2021), \n\nEn mérito de lo expuesto,\n\n"}
		articulo = Articulo{Texto: "VINCULAR para el PRIMER PERIODO académico de 2021 dentro periodo comprendido entre el veintitrés (23) de marzo de dos mil veintiuno (2021) y el veintitrés (23) de julio de dos mil veintiuno (2021),, en los programas de pregrado de la Universidad Distrital Francisco José de Caldas, en la modalidad de Medio Tiempo y Tiempo Completo Ocasional  en el escalafón y dedicación establecidas en la siguiente tabla, con recursos asignados en el Certificado de Disponibilidad Presupuestal Certificado de Disponibilidad Presupuestal (Sueldo Básico, Prima Vacaciones, Prima Navidad, Prima de Servicios y Cesantías)No. xxx del xx de enero de 2021, a los siguientes docentes:\n\n"}
		// accion = "Vincular"
	...
	if dedicacion == "HCP" && nivel == "POSGRADO" {
		...
		if dedicacion == "HCP" && nivel == "PREGRADO" {
			articulo = Articulo{Texto: "En caso de incumplimiento, retiro del docente o en caso de que los espacios académicos no cumplan con las condiciones establecidas para su apertura y/o continuidad, la Universidad Distrital Francisco José de Caldas, mediante acto administrativo motivado, declarará la terminación del vínculo y la liquidación con corte a la fecha del respectivo cumplido, cancelando las correspondientes prestaciones sociales, conforme al cálculo que efectúe la División de Recursos Humanos.\n\n"}
			articulos = append(articulos, articulo)
		}
		if dedicacion == "HCH" && nivel == "PREGRADO" {
			// Pregrado y HCH
			articulo = Articulo{Texto: "TERMINACION. En caso de incumplimiento, retiro del docente o en caso de que los espacios académicos no cumplan con las condiciones establecidas para su apertura y/o continuidad, la Universidad Distrital Francisco José de Caldas, mediante acto administrativo motivado, declarará la terminación del reconocimiento con corte a la fecha del respectivo cumplido, cancelando los correspondientes Honorarios, conforme al cálculo que efectúe la División de Recursos Humanos."}
			articulos = append(articulos, articulo)
		}
		if dedicacion == "TCO-MTO" {
			articulo = Articulo{Texto: "En caso de incumplimiento, retiro del docente o en caso de que los espacios académicos no cumplan con las condiciones establecidas para su apertura y/o continuidad, la Universidad Distrital Francisco José de Caldas, mediante acto administrativo motivado, declarará la terminación del reconocimiento con corte a la fecha del respectivo cumplido, cancelando los correspondientes Honorarios, conforme al cálculo que efectúe la División de Recursos Humanos.\n\n"}
	...
	if dedicacion == "HCH" && nivel == "PREGRADO" {
		articulo = Articulo{Texto: "VIGENCIA. -  El presente acto administrativo se expide a los XXX (XXX) días del mes de XXX del año dos mil XXX (20XX) y surte efectos de conformidad con la Resolución Nro. 06 de 2 de marzo de 2021, por medio del cual se expide el calendario académico para el primer semestre del año 2021, en concreto, para las actividades académicas relacionadas con el primer periodo académico del año 2021, que corresponde del veintitrés (23) de marzo de dos mil veintiuno (2021) y el veintitrés (23) de julio de dos mil veintiuno (2021)."}
		articulos = append(articulos, articulo)
	}
	//TCO-MTO
	if dedicacion == "TCO-MTO" {
		articulo = Articulo{Texto: "El presente acto administrativo se expide a los XXX (XXX) días del mes de XXX del año dos mil XXX (20XX) y surte efectos de conformidad con la Resolución No. 06 de marzo dos  (2) de 2021, por medio del cual se expide el calendario académico para el primer semestre del año 2021, en concreto, para las actividades académicas relacionadas con el primer periodo académico del año 2021, que corresponde del veintitrés (23) de marzo de dos mil veintiuno (2021) y el veintitrés (23) de julio de dos mil veintiuno (2021).\n\n"}
		articulos = append(articulos, articulo)
	}
	// Prestación
	if dedicacion == "HCP" && nivel == "PREGRADO" {
		articulo = Articulo{Texto: "El presente acto administrativo se expide a los XXX (XXX) días del mes de XXX del año dos mil XXX (20XX) y surte efectos de conformidad con la Resolución No. 06 de marzo dos  (2) de 2021, por medio del cual se expide el calendario académico para el primer semestre del año 2021, en concreto, para las actividades académicas relacionadas con el primer periodo académico del año 2021, que corresponde del veintitrés (23) de marzo de dos mil veintiuno (2.021) y el veintitrés (23) de julio de dos mil veintiuno (2021).\n\n"}
		articulos = append(articulos, articulo)
	}
	if dedicacion == "HCP" && nivel == "POSGRADO" {
