...
func GetTemplateResolucion(dedicacion, nivel, periodo, tipo string, numero string) (res ResolucionCompleta) {
	...
	articulos = append(articulos, articulo)
	if dedicacion == "HCH" && nivel == "POSGRADO" {
		articulo = Articulo{Texto: "Los docentes deberán cumplir con las obligaciones inherentes a la naturaleza del servicio, contempladas en la Ley, en los Reglamentos de la Universidad y en los Planes de Trabajo entregados por el profesor y aprobados por el Decano (a).\n\n"}
	} else {
	...
	articulos = append(articulos, articulo)
	articulo = Articulo{Texto: "El presente acto administrativo se expide a los ______________________(__) días del mes de agosto del año dos mil diecinueve (" + strconv.Itoa(vigencia) + ") y surte efectos de conformidad con la resolución 112 de diciembre 18 de 2018, por medio del cual se expide el calendario académico para el año 2019 para las actividades académicas tercer periodo académico del año 2019 que corresponde del agosto quince (15) y hasta diciembre dieciséis (16) del 2019."}
	articulos = append(articulos, articulo)
