...
func GetTemplateResolucion(dedicacion, nivel, periodo, tipo string) (res ResolucionCompleta) {
	...
	*/
	...
	if dedicacion == "TCO-MTO" {
		...
		paragrafo := Paragrafo{Texto: "El pago de los salarios a los profesores de vinculación especial se realizará máximo entre los primeros cinco (5) días hábiles de cada mes.\n\n"}
		articulo.Paragrafos = append(articulo.Paragrafos, paragrafo)
	...
	if dedicacion == "HCP" && nivel == "POSGRADO" {
		...
		if dedicacion == "TCO-MTO" {
			articulo = Articulo{Texto: "En caso de incumplimiento, retiro del docente o en el momento que se declare la cancelación de actividades académicas, por parte del Consejo Superior Universitario de la Universidad Distrital Francisco José de Caldas, mediante acto administrativo motivado, declarará la terminación del vínculo laboral y la liquidación con corte a la fecha del respectivo cumplido, cancelando las correspondientes prestaciones sociales, conforme al cálculo que efectúe la División de Recursos Humanos.\n\n"}
			articulos = append(articulos, articulo)
		}
	}
	/////ARTICULO 5
	...
	if dedicacion == "HCH" && nivel == "PREGRADO" {
		articulo = Articulo{Texto: "VIGENCIA. -  El presente acto administrativo surte efectos de conformidad con la Resolución 014 de 29 de marzo de 2022, por medio del cual se modificó el calendario académico especial para el primer periodo académico del año 2022, en concreto, para las actividades académicas relacionadas en el primer periodo académico 2022-I, comprendidas entre el 26 de abril y el 19 de agosto de 2022.\n\n"}
		articulos = append(articulos, articulo)
	}
	//TCO-MTO
	if dedicacion == "TCO-MTO" {
		articulo = Articulo{Texto: "El presente acto administrativo surte efectos de conformidad con la Resolución 014 de 29 de marzo de 2022, por medio de la cual se modificó el calendario académico para el primer periodo académico del año 2022, en concreto, para las actividades académicas relacionadas en el primer periodo académico 2022-I, comprendido entre el 26 de abril y 19 de agosto de 2022.\n\n"}
		articulos = append(articulos, articulo)
	}
	// Prestación
	if dedicacion == "HCP" && nivel == "PREGRADO" {
		articulo = Articulo{Texto: "VIGENCIA. El presente acto administrativo surte efectos de conformidad con la Resolución 014 de 29 de marzo de 2022, por medio del cual se modificó el calendario académico para el primer periodo académico del año 2022, en concreto, para las actividades académicas relacionadas en el primer periodo académico 2022-I, comprendido entre el 26 de abril y 19 de agosto de 2022.\n\n"}
		articulos = append(articulos, articulo)
	}
	if dedicacion == "HCP" && nivel == "POSGRADO" {
