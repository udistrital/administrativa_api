...
func GetTemplateResolucion(dedicacion, nivel, periodo, tipo string) (res ResolucionCompleta) {
	...
	*/
	...
	/////ARTICULO 8
	if dedicacion == "HCH" && nivel == "POSGRADO" {
		articulo = Articulo{Texto: "VIGENCIA. -  El presente acto administrativo se expide a los XXX (XXX) días del mes de XXX del año dos mil veintidós (2022) y surte efectos de conformidad con la Resolución No. 051 de septiembre 28 de 2021, por medio del cual se expide el calendario académico para el año 2022, en concreto, para las actividades académicas relacionadas con el tercer periodo académico del año 2022, que corresponde del ocho (8) de agosto de dos mil veintidós (2022) y hasta el diecisiete (17) de diciembre del dos mil veintidós (2022).\n\n"}
		articulos = append(articulos, articulo)
	}
	if dedicacion == "HCP" && nivel == "POSGRADO" {
	...
	if dedicacion == "HCH" && nivel == "PREGRADO" {
		articulo = Articulo{Texto: "VIGENCIA. El presente acto administrativo surte efectos de conformidad con las Resoluciones 014 y 038 de 2022, por medio de las cuales se modificó el calendario académico para los periodos académicos 2022-I y 2022-III y demás normas concordantes, complementarias y modificatorias.\n\n"}
		articulos = append(articulos, articulo)
	}
	//TCO-MTO
	if dedicacion == "TCO-MTO" {
	...
	// Prestación
	if dedicacion == "HCP" && nivel == "PREGRADO" {
		articulo = Articulo{Texto: "VIGENCIA. El presente acto administrativo surte efectos de conformidad con las Resoluciones 014 y 038 de 2022, por medio de las cuales se modificó el calendario académico para los periodos académicos 2022-I y 2022-III y demás normas concordantes, complementarias y modificatorias.\n\nDada en Bogotá D.C., a los xxxxxxx (00) días del mes de agosto del año 2022.\n\n"}
		articulos = append(articulos, articulo)
	}
	if dedicacion == "HCP" && nivel == "POSGRADO" {
		articulo = Articulo{Texto: "VIGENCIA. -  El presente acto administrativo se expide a los XXX (XXX) días del mes de XXX del año dos mil veintidós (2022) y surte efectos de conformidad con la Resolución No. 051 de septiembre 28 de 2021, por medio del cual se expide el calendario académico para el año 2022, en concreto, para las actividades académicas relacionadas con el tercer periodo académico del año 2022, que corresponde del ocho (8) de agosto de dos mil veintidós (2022) y hasta el diecisiete (17) de diciembre del dos mil veintidós (2022).\n\n"}
