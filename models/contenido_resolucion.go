...
func GetTemplateResolucion(dedicacion, nivel, periodo, tipo string) (res ResolucionCompleta) {
	...
	/////ARTICULO 9
	if dedicacion == "HCH" && nivel == "POSGRADO" {
		articulo = Articulo{Texto: "El presente acto administrativo se expide a los _____________________ (____) días del mes de ___________ del año dos mil veinte (2020) y surte efectos de conformidad con la Resolución No. ___________________ de ______ (_____) de 2020, por medio del cual se expide el calendario académico para el año 2020, en concreto, para las actividades académicas relacionadas con el periodo académico del año 2020, que corresponde del ________________________ (____) de ___________ al ______________ (_____) de ________ del 2020."}
		articulos = append(articulos, articulo)
	}
	if dedicacion == "HCH" && nivel == "PREGRADO" {
		// Pregrado y HCH
		articulo = Articulo{Texto: "El presente acto administrativo se expide a los ______________(_____) días del mes de __________ del año dos mil veinte 2020 y surte efectos de conformidad con la Resolución No. ______________ de __________ (_____) de 2020, por medio del cual se expide el calendario académico para el año 2020, en concreto, para las actividades académicas relacionadas con el periodo académico del año 2019, que corresponde del ________________ (_____) de _________________ al _________ (_________) de ___________ del 2020."}
		articulos = append(articulos, articulo)
	}
	if dedicacion == "TCO-MTO" {
		//TCO-MTO
		articulo = Articulo{Texto: "El presente acto administrativo se expide a los _______________ (_____) días del mes de _______________ del año dos mil veinte (2020) y surte efectos de conformidad con la Resolución No. ______________ de _________ (________) de 2020, por medio del cual se expide el calendario académico para el año 2020, en concreto, para las actividades académicas relacionadas con el periodo académico del año 2019, que corresponde del _________ (_________) de _____________ al _____________ (_______) de __________ del 2020."}
		articulos = append(articulos, articulo)
	}
	if dedicacion == "HCP" && nivel == "PREGRADO" {
		articulo = Articulo{Texto: "El presente acto administrativo se expide a los _______________ (____) días del mes de __________________ del año dos mil veinte (2020) y surte efectos de conformidad con la Resolución No. ______________ de _____________ (___) de 2020, por medio del cual se expide el calendario académico para el año 2020, en concreto, para las actividades académicas relacionadas con el periodo académico del año 2019, que corresponde del ________________ (_____) de _________________ al ___________________ (___________) de ________________ del 2020."}
		articulos = append(articulos, articulo)
	}
	if dedicacion == "HCP" && nivel == "POSGRADO" {
		articulo = Articulo{Texto: "El presente acto administrativo se expide a los ___________________ (_______) días del mes de _________________ del año dos mil veinte (2020) y surte efectos de conformidad con la Resolución No. _____________ de __________________ (________) de 2020, por medio del cual se expide el calendario académico para el año 2020, en concreto, para las actividades académicas relacionadas con el periodo académico del año 2020, que corresponde del ____________ (______) de ________ al _________ (_______) de ______________ del 2020."}
		articulos = append(articulos, articulo)
	}
