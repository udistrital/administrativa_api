...
func GetTemplateResolucion(dedicacion, nivel, periodo, tipo string) (res ResolucionCompleta) {
	...
	*/
	...
	if dedicacion == "HCH" && nivel == "PREGRADO" {
		articulo = Articulo{Texto: "CONDICIONES. El pago de los honorarios a los Catedráticos por los servicios prestados a que se refiere el artículo anterior, según su escalafón, se hará previa certificación de las horas efectivamente dictadas, que se encuentren inmersas en el correspondiente plan de trabajo de la gestión académica, expedida por el decano y/o director de proyecto curricular.\n\n"}
		paragrafo := Paragrafo{Texto: "El valor del punto en pesos para el reconocimiento y pago de los docentes de hora cátedra honorarios, será el que fije el Gobierno Nacional mediante decreto cada año y que la Universidad Distrital Francisco José de Caldas acogerá mediante acto administrativo.\n\n"}
		articulo.Paragrafos = append(articulo.Paragrafos, paragrafo)
	}
	...
	if dedicacion == "HCH" && nivel == "PREGRADO" {
		...
		articulo.Paragrafos = append(articulo.Paragrafos, paragrafo)
		paragrafo = Paragrafo{Texto: "El docente cumplirá con lo establecido en la Circular Nro. 046 de julio 19 de 2017 de Rectoría, con relación al pago de aportes a seguridad social de forma independiente, de conformidad con la ley.\n\n"}
		articulo.Paragrafos = append(articulo.Paragrafos, paragrafo)
	}
	articulos = append(articulos, articulo)
	////ARTICULO 4
	...
	if dedicacion == "HCP" && nivel == "POSGRADO" {
		...
		if dedicacion == "HCP" && nivel == "PREGRADO" {
			articulo = Articulo{Texto: "TERMINACIÓN. En caso de incumplimiento o retiro del docente o en el momento que se declare la cancelación de actividades académicas por los órganos competentes de la Universidad Distrital Francisco José de Caldas, mediante acto administrativo motivado, se realizará la terminación del vínculo y la liquidación con corte a la fecha del respectivo cumplido, cancelando las correspondientes prestaciones sociales, conforme al cálculo que efectúe la División de Recursos Humanos.\n\n"}
			articulos = append(articulos, articulo)
		}
		if dedicacion == "HCH" && nivel == "PREGRADO" {
			// Pregrado y HCH
	...
	/////ARTICULO 8
	if dedicacion == "HCH" && nivel == "POSGRADO" {
		articulo = Articulo{Texto: "VIGENCIA. -  El presente acto administrativo se expide a los XXX (XXX) días del mes de XXX del año dos mil veintitres (2023) y surte efectos de conformidad con la Resolución No. 056 de septiembre 14 de 2022, por medio del cual se expide el calendario académico para el año 2023, en concreto, para las actividades académicas relacionadas con el periodo académico 2023-III, que corresponde del primero (01) de  agosto de dos mil veintitrés (2023) y hasta el veinticinco (25) de noviembre del dos mil veintitrés  (2023).\n\n"}
		articulos = append(articulos, articulo)
	}
	if dedicacion == "HCP" && nivel == "POSGRADO" {
	...
	if dedicacion == "HCH" && nivel == "PREGRADO" {
		articulo = Articulo{Texto: "VIGENCIA. El presente acto administrativo surte efectos de conformidad con la Resolución 057 de 04 de octubre de 2022, por medio del cual se establece el calendario académico para el primer semestre del año 2023, en concreto, para las actividades académicas relacionadas con el periodo académico 2023-I, comprendido entre el 1° de agosto de 2023 y el 9 de diciembre de 2023.\n\n\n"}
		articulos = append(articulos, articulo)
	}
	//TCO-MTO
	if dedicacion == "TCO-MTO" {
		articulo = Articulo{Texto: "VIGENCIA. El presente acto administrativo surte efectos de conformidad con la Resolución 057 de 04 de octubre de 2022, a través de la cual se fijó el calendario académico para los programas académicos 2023-I, 2023-II, 2023-III y proceso de admisión para el periodo académico 2024-I de la Universidad Distrital Francisco José de Caldas,\n\n\n"}
		articulos = append(articulos, articulo)
	}
	// Prestación
	if dedicacion == "HCP" && nivel == "PREGRADO" {
		articulo = Articulo{Texto: "VIGENCIA. El presente acto administrativo surte efectos de conformidad con la Resolución 057 de 4 de octubre de 2022, a través de la cual se fijó el calendario académico para los programas académicos 2023-I, 2023-II, 2023-III y proceso de admisión para el periodo académico 2024-I de la Universidad Distrital Francisco José de Caldas, en concreto, para las actividades académicas relacionadas con el periodo académico 2023-III, comprendido entre el XX de 202X y el XX de XXXXX de 202X.\n\n\n"}
		articulos = append(articulos, articulo)
	}
	if dedicacion == "HCP" && nivel == "POSGRADO" {
		articulo = Articulo{Texto: "VIGENCIA. -  El presente acto administrativo se expide a los XXX (XXX) días del mes de XXX del año dos mil veintitrés (2023) y surte efectos de conformidad con la Resolución No. 056 de septiembre 14 de 2022, por medio del cual se expide el calendario académico para el año 2023, en concreto, para las actividades académicas relacionadas con el primer periodo 2023-III, que corresponde del  primero (01) de agosto de dos mil veintitrés (2023) y hasta el veinticinco (25) de noviembre de dos mil  veintitrés (2023).\n\n"}
		articulos = append(articulos, articulo)
