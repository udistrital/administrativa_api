...
type RelacionParametroContraloriaController struct {
	beego.Controller
}

// URLMapping ...
func (c *RelacionParametroContraloriaController) URLMapping() {
...
func (c *RelacionParametroContraloriaController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddRelacionParametroContraloria(&v); err == nil {
