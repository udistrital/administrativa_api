...
// CatalogoElementoController oprations for CatalogoElemento
type CatalogoElementoController struct {
	beego.Controller
}

// URLMapping ...
func (c *CatalogoElementoController) URLMapping() {
...
func (c *CatalogoElementoController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddCatalogoElemento(&v); err == nil {
