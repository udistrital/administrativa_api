...
// @Success 201 {int} models.Salida
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *SalidaController) Post() {
	var v models.Salida
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddSalida(&v); err == nil {
...
// @router /:id [get]
func (c *SalidaController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetSalidaById(id)
	if err != nil {
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "000", "Body": err.Error(), "Type": "error"}
		c.Data["system"] = err
...
// @Failure 404 not found resource
// @router / [get]
func (c *SalidaController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllSalida(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
		//c.Data["development"] = map[string]interface{}{"Code": "000", "Body": err.Error(), "Type": "error"}
		c.Data["system"] = err
...
func (c *SalidaController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Salida{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateSalidaById(&v); err == nil {
			c.Data["json"] = v
		} else {
			logs.Error(err)
			//c.Data["development"] = map[string]interface{}{"Code": "000", "Body": err.Error(), "Type": "error"}
...
// @Failure 404 not found resource
// @router /:id [delete]
func (c *SalidaController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteSalida(id); err == nil {
